...
final class Curve
{
    ...
    static final Curve SECP256K1 = new Curve(
        SecP256K1Curve.q,
     ...
     */
    ECPoint point (BigInteger x, boolean yOdd) {
     ...
     */
    BigInteger[] sign (BigInteger privateKey, byte[] message) {
     ...
     */
    BigInteger[] signWithRandomK (BigInteger privateKey, byte[] message) {
     ...
     */
    boolean verify (ECPoint publicKey, BigInteger r, BigInteger s, byte[] message) {
