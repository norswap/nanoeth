...
/**
 * A zero-knowledge proof that the prover knows two identically-sized vectors of values and their
 * inner product. This proof doubles as a commitment to these two vectors.
 * <p>
 * TODO explain the point
 */
public class InnerProductProof {
    ...
    public InnerProductProof (Curve curve, ECPoint[] basis, BigInteger[] a, BigInteger[] b) {
